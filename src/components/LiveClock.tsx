...
export function LiveClock() {
  const [parts, setParts] = useState(() => getBdParts());
  ...
  return (
    <div className="glass-card rounded-2xl p-5 sm:p-6 flex items-center justify-between gap-4">
      <div>
        ...
        <div className="text-lg sm:text-2xl font-bold mt-1">{parts.dateStr}</div>
      ...
      <div className="text-right">
        ...
        <div className="text-2xl sm:text-4xl font-mono font-bold text-gradient tabular-nums">
          {parts.timeStr}
        </div>
      </div>
    </div>
